...
4. **Native-напоминалки** по главам (Capacitor local notifications) + сохранение PDF/картинки в Файлы. ⚠️ бОльшая native-задача (`app/`), нужен вектор владельца.
5. Фолбэк памятки на 12 языков (или убрать, если ИИ-путь надёжен).
6. Остаток паритета памятки/велнес-KB в PRO (терминология гормонов уже закрыта, см. выше).
7. ✅ **Глазной тест частично сделан** (curl жен-пери vs муж-46 — различаются, 0 утечек); остаётся визуальный проход владельца по живой странице.
