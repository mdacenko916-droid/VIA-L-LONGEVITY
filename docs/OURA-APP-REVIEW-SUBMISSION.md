...
## 3. ⚠️ Одна дыра перед подачей — политика приватности
...
⚠️ Правку в юридический текст **не вносил — жду вашего решения**. Если согласны, добавляю
в EN-версию и в остальные 11 языков (политика локализована).

---

## 4. Порядок действий

1. Согласовать правку политики (п. 3) → внести → `git push` (деплой ~1–2 мин).
