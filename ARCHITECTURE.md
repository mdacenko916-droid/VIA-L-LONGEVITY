...
**Целевая аудитория (общая для обоих продуктов):** женщины 40+
(пременопауза / менопауза / постменопауза) и мужчины 45+ (андропауза /
предандропауза). Это сужает контент, скоринг и KB-паттерны: фокус — на
гормональном здоровье после 40/45, а не на общем wellness.
...
| `interpreter-pro-expert.html` | PRO + EXPERT | 16 | ✓ | 2 в 30 дней | — | 12 яз. |
| `interpreter-elite.html` | ELITE (8w / 12w) | 16 + onboarding | ✓ | 8 за 8 нед / 12 за 12 нед (еженедельный) | опц. для uk/ru, 1:1 ≈ раз в 1–3 нед | 12 яз. |
