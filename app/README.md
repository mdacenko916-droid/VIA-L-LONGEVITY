...
- [~] **IAP для VIA·L** (€30/мес, RevenueCat, см. `IAP.md`) — код готов, ждёт настройки владельцем
...
- **PRO в приложении:** РЕШЕНО (2026-07-15) — только Apple IAP (auto-renewable subscription,
  €30/мес), НЕ код с сайта/Hotmart (Hotmart как канал продаж отвязан). Код готов — см. `IAP.md`
