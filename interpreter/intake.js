...
(function () {
  ...
  var TX = {
    ...
    push: { ru: 'Ваш список на {t} — откройте VIA·L', uk: 'Ваш список на {t} — відкрийте VIA·L', en: 'Your {t} list — open VIA·L', es: 'Tu lista de las {t} — abre VIA·L', de: 'Deine Liste für {t} — öffne VIA·L', pt: 'A sua lista das {t} — abra a VIA·L', fr: 'Votre liste de {t} — ouvrez VIA·L', pl: 'Twoja lista na {t} — otwórz VIA·L', it: 'La tua lista delle {t} — apri VIA·L', he: 'הרשימה שלכם ל־{t} — פתחו את VIA·L', ja: '{t} のリスト — VIA·L を開く', ko: '{t} 목록 — VIA·L 열기' },
