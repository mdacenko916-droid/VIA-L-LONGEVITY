...
function wellnessHardScrub(text, lang) {
  ...
  // 5) markdown-разделители «---»/«***» — в структурном формате их быть не должно, но модель их вставляет
  // между темами → в вёрстке слипались с кнопкой («---Свернуть»). Убираем строки из одних дефисов/звёздочек.
...
const _STRUCTURED_FMT =
  ...
  'НЕ вставляй горизонтальные разделители «---», «***» между темами — разделение задаёт сам формат [[S]].\n' +
