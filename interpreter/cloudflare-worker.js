...
════════════════════════════════════════
Принцип (Perry Academy, Sims/Wittstein): в перименопаузе нагрузка = замена эстрогенового сигнала (↓анаболизм, слабее сокращение). СИЛА одним рычагом улучшает состав тела + метаболизм + кости + ↓боль в суставах. Приоритет — НЕ изматывающее кардио, а сила + белок (1.6–2 г/кг) + восстановление.
Ядро: 1) силовая «тяжело-мало» (3–6 повт, высокая для клиента нагрузка, 2–3×/нед) — фундамент; 2) мягкая плиометрика/низкие прыжки → кость + GLUT4 (глюкоза без инсулина); 3) истинный ВИИТ (≥80% ЧСС, 1–4 мин + полное восстановление, 2–4 раунда) — ↓кортизол, ↑сон; 4) короткие спринты ≤30 сек; 5) Zone2/прогулки — «для души», не замена силы. Меньше «серой зоны».
...
**Движение** — 2–4 строки: персональная рекомендация по нагрузке под фазу, ИМТ/вес, симптомы и метрики (HRV/сон/готовность — авторегуляция: грузить силу/мощность или восстанавливаться). Сила в приоритете; тёплый мотивационный тон, маленькие шаги без вины; при хронике (сердце/остеопороз/тазовое дно) — мягко «согласовать с врачом».
