...
РИТМ ДНЯ (циркадный) — утро: свет + белковый завтрак; день: пик ясности для сложных задач; после обеда — короткая прогулка; вечер: тусклый свет, спокойствие, продукты с магнием, экраны убрать.
