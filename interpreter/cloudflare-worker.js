...
async function handleAnalyze(request, env, corsHeaders, ctx) {
  ...
  const wellnessGuard = isWellness ? (
    ...
    '• НЕ называть конкретные гормоны и приборные метрики как замеры (тестостерон, эстроген, прогестерон, кортизол, ТТГ, HRV). Говори: «внутренний баланс», «ритмы восстановления», «энергия», «тонус», «нагрузка».\n' +
...
const _FEED_DEMED = [
  ...
  [/эстрадиол[а-яё]*/gi, 'гормональный баланс'],
  [/эстрон[а-яё]*/gi, 'гормональный баланс'],
  [/эстроген[а-яё]*/gi, 'гормональный баланс'],
  [/прогестерон[а-яё]*/gi, 'гормональный баланс'],
  [/тестостерон[а-яё]*/gi, 'мужская витальность'],
  [/кортизол[а-яё]*/gi, 'ритмы стресса и восстановления'],
  [/пролактин[а-яё]*/gi, 'гормональный баланс'],
  [/ароматаз[а-яё]*/gi, 'обменный процесс'],
  [/I3C\/DIM/gi, 'растительные компоненты крестоцветных'],
  [/\bDIM\b/g, 'растительная поддержка'],
  [/SHBG/g, 'гормональный баланс'],
