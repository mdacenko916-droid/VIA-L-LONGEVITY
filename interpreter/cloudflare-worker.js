...
async function handleAnalyze(request, env, corsHeaders, ctx) {
  ...
  const wellnessGuard = isWellness ? (
    ...
    '• ДВИЖЕНИЕ/ОБМЕН — тоже в велнес-словах: «саркопения» → «естественная возрастная потеря мышечной формы»; «остеопения/остеопороз/МПК» → «крепость и плотность костей»; «инсулинорезистентность/метаболический синдром/диабет» → «как тело отвечает на сахар и углеводы», «углеводный баланс»; «висцеральный жир» → «внутренний (глубинный) жир»; «СРБ/воспаление как маркёр» → «фоновая нагрузка», «ресурс восстановления». Силовую и любую нагрузку подавай как заботу о форме, энергии, крепости костей и тонусе — НЕ как профилактику или лечение болезней. Дозировку (вид/периодичность) давать можно — это образ жизни, не медицина.\n' +
