...
const _FEED_DEMED = [
  ...
  [/\bЗГТ\b|заместительн[а-яё]*\s*гормональн[а-яё]*\s*терапи[а-яё]*/gi, 'циклические маркеры комфорта'],
  [/\bКОК\b|контрацептив[а-яё]*|оральн[а-яё]*\s*контрацепци[а-яё]*/gi, 'циклические маркеры комфорта'],
