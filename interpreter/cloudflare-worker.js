...
const WELLNESS_STYLE_OURA =
  ...
  '• НЕ пиши «выводить/избыток баланса» (баланс не «выводят») → «поддерживает здоровый гормональный/внутренний баланс». Прямые физиологические термины (гормональный баланс, эстроген, кортизол) РАЗРЕШЕНЫ во всех тарифах, НО только как ПАТТЕРН/ЗАБОТА, НИКОГДА как ЗАМЕР («ваш кортизол повышен») или диагноз. НЕ выноси вердиктов «это норма / это не норма» о состояниях — вместо этого «частое явление», «многим знакомо».\n' +
  '\n' +
