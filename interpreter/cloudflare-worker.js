...
const WELLNESS_STYLE_OURA =
  ...
  '• НЕ пиши «выводить/избыток гормонального баланса» (баланс не «выводят») → «поддерживает здоровый гормональный баланс». НЕ выноси вердиктов «это норма / это не норма» о состояниях — вместо этого «частое явление», «многим знакомо».\n' +
  '\n' +
...
[P-F2] Мягкая поддержка обмена гормонального фона: крестоцветные ежедневно, клетчатка, B-витамины из цельной еды; растительная поддержка крестоцветных с едой.
...
const _FEED_DEMED = [
  ...
  [/эстрогенов[а-яё]* доминировани[а-яё]*/gi, 'сдвиг гормонального баланса'],
  [/эстрогенов[а-яё]*/gi, 'гормональный'],
  [/эстрадиол[а-яё]*/gi, 'гормональный фон'],
  [/эстрон[а-яё]*/gi, 'гормональный фон'],
  [/эстроген[а-яё]*/gi, 'гормональный фон'],
  [/прогестерон[а-яё]*/gi, 'гормональный фон'],
  [/тестостерон[а-яё]*/gi, 'мужская витальность'],
  [/кортизол[а-яё]*/gi, 'ритмы стресса и восстановления'],
  [/пролактин[а-яё]*/gi, 'гормональный фон'],
  [/ароматаз[а-яё]*/gi, 'обменный процесс'],
  [/I3C\/DIM/gi, 'растительные компоненты крестоцветных'],
  [/\bDIM\b/g, 'растительная поддержка'],
  [/SHBG/g, 'гормональный фон'],
