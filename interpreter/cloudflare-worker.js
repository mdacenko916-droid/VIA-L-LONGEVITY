...
async function handleDayPlan(request, env, corsHeaders, ctx) {
  ...
  const schema =
    ...
    '• morning: секции «Утренний старт», «Разминка», «Завтрак · соберите тарелку · выберите один (~N г белка)» (variants:true, 4–6 вариантов; каждый = белок+овощи/клетчатка+медленный углевод с бытовой граммовкой), «Нутрицевтики (утро)». В «Утреннем старте»: пункт про время подъёма начинай существительным «Подъём в одно и то же время (даже в выходные)…» (на языке клиента), НЕ императивом «Встаньте»; утренний свет — «яркий свет 10–15 мин после пробуждения», НЕ 30 мин.\n' +
    ...
    '• lunch: «Обед · тарелка ½ овощи · ¼ белок · ¼ медленные углеводы · выберите один (~N г белка)» (variants:true, 4–6), «Нутрицевтики (обед)».\n' +
    ...
    '• sleep: секция «Поведенческие ориентиры вечера» (вечерние привычки и спокойный ритм: фикс. подъём, прохладная тёмная спальня, тусклый свет, дыхание, кровать только для сна) + при наличии сигналов секция «Для вечернего комфорта». ⚠️ ЗАПРЕЩЕНЫ клинические аббревиатуры и термины: CBT-I, КПТ, «терапия», «протокол», «бессонница», «инсомния», имена авторов/академий (Perry, Shelby Harris) — это велнес, не медицина.\n' +
