...
• ВЕС/ИМТ ↑: старт суставно-щадящий (присед к стулу, тренажёры, вода, велотренажёр); высокие прыжки — позже; интервалы на велотренажёре/в воде. На ГПП-1/быстром похудении силовая + белок ОБЯЗАТЕЛЬНЫ (беречь мышцу).
• СУСТАВЫ/боль/артрит: сила в БЕЗБОЛЕЗНЕННОЙ амплитуде, разминка, без ударных прыжков; хорошо — вода.
• ОСТЕОПОРОЗ/остеопения/факторы риска кости: опорная+силовая обязательны, НО без высоких прыжков и сгибаний/скручиваний позвоночника с весом; + баланс (профилактика падений).
