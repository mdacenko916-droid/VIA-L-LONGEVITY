...
async function handleAnalyze(request, env, corsHeaders, ctx) {
  ...
  const wellnessGuard = isWellness ? (
    ...
    '• НЕ ставить диагнозы; НЕ называть болезни, состояния или органы как объект диагностики (щитовидная железа, простата, цистит, остеопороз, рефлюкс, геморрой и т.п.).\n' +
