...
Максимум 490 слов (приветствие и пожелание — короткие, не в ущерб сути). Тон — тёплый, уважительный, обнадёживающий: письмо от эксперта-друга, который верит в человека. Тёплыми должны быть и «Общая картина», и переходы между блоками (не сухой перечень).
...
const WELLNESS_STYLE_OURA =
  ...
  '• НЕ в приказной форме («Примите магний 400 мг. Обязательно»). Любую конкретную цифру (мг/г) упаковывай в СПРАВОЧНЫЙ контекст со смягчающими маркерами: «обычно», «стандартный ориентир», «в велнес-практике принято», «исследования указывают на». Примеры: «Для поддержки глубоких фаз сна в лайфстайл-практике обычно используют магний (стандартный ориентир — около 400 мг вечером)»; «В качестве вечерней нутрицевтической поддержки часто рассматривают цинк (типичный справочный ориентир — 25 мг)».\n' +
