...
const _STRUCTURED_FMT =
  ...
  'СТРУКТУРА ВНУТРИ [[D]] (RC2 — план действий, НЕ статья): короткие строки-подзаголовки жирным на ОТДЕЛЬНОЙ строке (переведи на язык ответа): **Что происходит** — 1–2 фразы почему; **Что сделать** — 3–5 коротких ДЕЙСТВИЙ, каждое с новой строки начиная с «☐ » (императив, конкретно); **На этой неделе** — одна главная ☐-цель. Заголовок после [[S]] — ГЛАГОЛЬНЫЙ («Подготовьтесь ко сну», не «Сон»). НЕ нумеруй цифрами, не пиши длинные абзацы; смягчители «может» — только для причин/интерпретаций.\n' +
