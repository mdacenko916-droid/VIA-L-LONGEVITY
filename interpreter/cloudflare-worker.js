...
Питание/образ жизни: снижение веса — сильнейшая мера (PRIDE: ~8% массы → −58% эпизодов стрессового недержания; каждый 1 кг = −3% риска); сократить кофеин (даже 1 чашка/день ↑сократимость детрузора), газировку, алкоголь; жидкость малыми порциями до ~2 л/день, меньше перед сном (ноктурия).
...
Уточнения (мужская специфика): гипотиреоз → гипогонадотропный гипогонадизм со ↓своб. тестостерона, обратимо левотироксином → ПРОВЕРИТЬ ТТГ ДО старта ТЗТ (иногда LT4 один восстанавливает тестостерон). ⚠️ ТЗТ ↓ТСГ → у мужчин на LT4 риск передозировки → снизить LT4 на 25–50%, ТТГ через 6–8 нед. Субклин. гипотиреоз у мужчин → метаболический синдром (HR 1.87) и ↑ЛПНП; ЭД-связь — при ЭД проверить ТТГ, ИФДЭ-5 отложить 6 мес после эутиреоза. ⚠️ Биотин (≥10 мг) искажает анализ → ложно ↓ТТГ/↑fT4: отменить за ≥48–72 ч.
