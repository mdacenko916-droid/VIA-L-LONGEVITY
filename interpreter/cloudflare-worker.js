...
Максимум 400 слов. Тон — тёплый, уважительный, обнадёживающий: письмо от эксперта-друга, который верит в человека. Тёплыми должны быть и «Общая картина», и переходы между блоками (не сухой перечень).
