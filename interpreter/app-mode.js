...
(function(){
  ...
  function apply(){
    ...
    // самое случайно работало — там WebChromeClient грузит такую ссылку в то же окно. Убираем
    // расхождение платформ; на вебе target остаётся, там новая вкладка уместна.
    document.querySelectorAll('a[href*="legal/"][target="_blank"]').forEach(function(a){
