...
**Целевая аудитория:** женщины 40+ (пременопауза / менопауза / постменопауза) и мужчины 45+ (андропауза / предандропауза). Контент, скоринг, KB-паттерны и LAB MODULE спроектированы под гормональное здоровье после 40/45.
...
| PRO+EXPERT   | interpreter-pro-expert.html | 16             | ✓ Claude  | 2 PDF в 30 дней (cooldown 7 дней) | —                      | €79/мес    |
| ELITE-8W     | interpreter-elite.html      | 16 + onboarding| ✓ Claude  | до 8 PDF за 8 недель (еженедельно) | опц. для uk/ru, ≈1/3 нед | €390       |
| ELITE-12W    | interpreter-elite.html      | 16 + onboarding| ✓ Claude  | до 12 PDF за 12 недель (еженедельно) | опц. для uk/ru, ≈1/3 нед | €590       |
...
**PRO / PRO+EXPERT / ELITE (16 шагов, step0–step15 + stepResult):**
