...
**Бизнес-модель:** доступ по коду (выдаётся вместе с гайдом VIA-L на Hotmart). Три уровня тарифов с нарастающей глубиной анализа.
...
├── interpreter-pro.html        # Интерпретатор PRO  — 14 шагов + AI
├── interpreter-pro-expert.html # Интерпретатор PRO-EXPERT — 16 шагов + AI + Expert
├── interpreter-elite.html      # Интерпретатор ELITE — 16 шагов + AI + Elite консультация
│
...
| Тариф       | Файл                        | Шагов | AI-анализ | Expert-консультация | Цена       |
|-------------|-----------------------------|-------|-----------|---------------------|------------|
| VIO (Basic) | interpreter-vio.html        | 6     | —         | —                   | Бесплатно  |
| PRO         | interpreter-pro.html        | 14    | ✓ Claude  | —                   | €29/мес    |
| PRO-EXPERT  | interpreter-pro-expert.html | 16    | ✓ Claude  | ✓ (письм., 48 ч)   | €79/мес    |
| ELITE       | interpreter-elite.html      | 16    | ✓ Claude  | ✓ (приоритет)       | €390/€590  |
...
**PRO (14 шагов, step0–step13 + stepResult):**

step0 HRV → step1 Температура → step2 Сон → step3 Пульс/симптомы → step4 Когнитивные функции → step5 Питание → step6 Энергия/образ жизни → step7 Гормональный профиль → step8 Стресс/кортизол → step9 Физическая активность → step10 Лабораторные показатели → step11 Цикл (женщины) → step12 Биоимпеданс → step13 Тренд недели → stepResult AI-анализ

**ELITE / PRO-EXPERT (16 шагов, step0–step15 + stepResult):**

Аналогично PRO + два дополнительных шага: step14 (углублённый гормональный / специфика тарифа) + step15 (динамика за неделю — тренд, изменения, события).
...
**Поддерживаемые языки (12):** `ru`, `uk`, `en`, `es`, `de`, `pt`, `fr`, `pl`, `it`, `he`, `ja`, `ko`
