...
**Краткий статус:** ждём вендора. Кода в воркере ещё нет. **Третья подача — форма
`partnerships.ultrahuman.com`, текст готов: `docs/ULTRAHUMAN-API-FORM-2026-08.md`** (2026-08-27).
